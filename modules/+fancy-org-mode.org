...
(use-package org
  ...
  (add-to-list 'org-capture-templates
               '("xs"
                 ...
                 (file "~/EnvSetup/config/org/snippet.template")
                 ;; "* %?\t%^g\n #+BEGIN_SRC %^{language}\n\n#+END_SRC"
                 :kill-buffer t))
  ...
  (add-to-list 'org-capture-templates
               '("xb"
                 ...
                 (file "~/EnvSetup/config/org/billing.template")
                 ;; " | %U | %^{类别} | %^{描述} | %^{金额} |"
                 :kill-buffer t))
  ...
  (add-to-list 'org-capture-templates
               '("xc"
                 ...
                 (file "~/EnvSetup/config/org/contact.template")
  ...
  (add-to-list 'org-capture-templates
               '("ts"                                              ; hotkey
                 ...
                 (file "~/EnvSetup/config/org/basic.template")))
  ...
  (add-to-list 'org-capture-templates
               '("tp"
                 ...
                 (file "~/EnvSetup/config/org/project.template")
                 :empty-line 1))
  ...
  (add-to-list 'org-capture-templates
               '("P"
                 ...
                 (file "~/EnvSetup/config/org/phone.template")
  ...
  (add-to-list 'org-capture-templates
               '("h"
                 ...
                 entry
                 (file habit-org-file)
                 (file "~/EnvSetup/config/org/habit.template")
                 ;; "* %^{Habit cards|music|balls|games}\n  %?"
                 :immediate-finish t
                 :new-line 1))
  ...
  (add-to-list 'org-capture-templates
               '("n"
                 ...
                 entry
                 (file notes-org-file)
                 (file "~/EnvSetup/config/org/notes.template")
                 ;; "* %^{Loggings For...} %t %^g\n  %?"
                 :immediate-finish t
                 :new-line 1))
